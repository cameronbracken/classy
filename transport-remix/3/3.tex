...
\begin{figure}[!htbp]
   \centering
   \subfigure[]{\includegraphics[width=.75\textwidth]{plume2d-contour.eps}}
   \subfigure[]{\includegraphics[width=.75\textwidth]{plume2d-surf.eps}}
...
\centering
	\begin{tikzpicture}
		...
		\draw[thick,->] (0,1) -- (0,2) node[anchor=east] {$q_{diff(out)}$};
