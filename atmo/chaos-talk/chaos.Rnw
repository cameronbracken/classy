...
\begin{document}
\SweaveOpts{prefix.string=figs/fig,external=T,echo=F}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
...
\begin{itemize}
	\item Syukuro Manabe 
	\item Juli\`an Adem
	\item Simpler than GCM and similar to EBM
...
\pause
<<sensitive,cache=T,external=T,fig=T,width=4,height=3>>=
...
\begin{itemize}
	...
	\item Unrealistically simple
	\item Terminal state of system is drastically different under different driving conditions (i.e. parameter values and bifurcation)
