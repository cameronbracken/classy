...
\fancyhead{}
\fancyfoot{}
% No line (rule) on top or bottom of page
\renewcommand{\headrulewidth}{0pt}
\renewcommand{\footrulewidth}{0pt}
% get rid of warning about too small headheight
\headheight 13.6pt
%page numbers on inside of page
...
code <- system('pygmentize -f latex src/states.R',intern=T)
cat(code,sep='\n')
@
