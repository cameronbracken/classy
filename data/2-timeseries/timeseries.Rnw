...
\begin{figure}[!ht]
\centering
<<seqpeak-par, echo=T, fig=T, tikz=T, cache=T,width=4,height=4, keep.source=F>>=
...
\begin{figure}[!ht]
\centering
<<may-pdf-par, echo=T, fig=T, tikz=T, cache=T, keep.source=T>>=
...
\begin{figure}[!ht]
\centering
<<seqpeak-mknn, echo=T, fig=T, tikz=T, cache=T,width=4,height=4, keep.source=F>>=
...
\begin{figure}[!ht]
\centering
<<may-pdf-mknn, echo=T, fig=T, tikz=T, cache=T, keep.source=T>>=
...
\begin{figure}[!ht]
\centering
<<seqpeak-imknn, echo=T, fig=T, tikz=T, cache=T,width=4,height=4, keep.source=F>>=
...
\begin{figure}[!ht]
\centering
<<may-pdf-imknn, echo=T, fig=T, tikz=T, cache=T, keep.source=T>>=
...
sm.density(x.may,add=T,col='red',lwd=2)
@
\caption{Interannual Modified K-NN May pdf.}
\end{figure}
